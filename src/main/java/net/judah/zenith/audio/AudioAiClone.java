 ...
 *
 * this clone ditched AudioResponseFormat to support .wav
 *
 * @author Christian Tzolov
 * @since 0.8.1
 */
public class AudioAiClone {

	private final RestClient restClient;
	private final WebClient webClient;

	public AudioAiClone(String openAiToken) {
	 ...
	 */
	public AudioAiClone(String baseUrl, String openAiToken, RestClient.Builder restClientBuilder,
	...
	// @formatter:off
		...
		public static class Builder {
			...
			public Builder withResponseFormat(String value) {
